...
class DatabaseClient:
    ...
    def insert_sentiment_db(self, df):
        ...
        for i in range(len(df)):
            ...
            cur.execute(
                f"INSERT INTO sentiment_fact (dateid, timeid, trading_symbol, comp_sentiment) VALUES ({dateid[0][0]}, {timeid[0][0]}, '{df['trading_symbol'][i]}', {df['final_scores'][i]});")
...
def main():
    ...
    overall_headlines = high_headlines
    ...
    #database_client.insert_sentiment_db(df)
